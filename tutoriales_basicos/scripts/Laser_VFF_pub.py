...
class ForceField():
    ...
    def calculateForce(self):
        ...
        self.force.theta=self.convert2pi(np.arctan2(sumy,sumx))
        self.force.x=sumx/Magnitude
        self.force.y=sumy/Magnitude
        self.force_publisher.publish(self.force)
        print 'Fx=',self.force.x,'Fy=',self.force.y,'Fa=',self.force.theta*180/np.pi
